package com.zyzyida.common.utils;

import com.zyzyida.common.constant.PropertiesConstants;
import com.zyzyida.common.model.MetricEvent;
import com.zyzyida.common.schemas.MetricSchema;
import com.zyzyida.common.watermarks.MetricWatermark;
...
import static com.zyzyida.common.constant.PropertiesConstants.*;
...
public class KafkaConfigUtil {
    ...
    public static Properties buildKafkaProps(ParameterTool parameterTool) {
        ...
        */
        ...
        props.setProperty("bootstrap.servers", DEFAULT_KAFKA_BROKERS);
        props.setProperty("zookeeper.connect", DEFAULT_KAFKA_ZOOKEEPER_CONNECT);
        props.setProperty("group.id", DEFAULT_KAFKA_GROUP_ID);
