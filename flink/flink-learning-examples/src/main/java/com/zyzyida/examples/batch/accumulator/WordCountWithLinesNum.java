...
/**
 * Desc:累加器
 * 介绍：将数据发送给 TaskManager，讨论如何从 TaskManager 中返回数据
 * Created by zhouyizhe on 2019-08-23
 */
public class WordCountWithLinesNum {
    public static void main(String[] args) throws Exception {
//        final ParameterTool params = ParameterTool.fromArgs(args); //读取命令行参数
//        final ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();
//        env.getConfig().setGlobalJobParameters(params); //使用 setGlobalJobParameters 设置全局作业参数
        final ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();
